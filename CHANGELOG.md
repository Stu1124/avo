...
- Tools for Messages, Mail, Calendar, Reminders, Notes, Finder, Spotify, Google Drive, Gmail and
  Google Calendar, plus Claude Code and Codex. Anything that sends, creates or changes something
  shows an editable card first.
